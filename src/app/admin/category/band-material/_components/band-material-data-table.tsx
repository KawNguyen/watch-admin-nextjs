...
export default function BandMaterialsDataTable() {
  const { data, isLoading } = useBandMaterials();
  const bandMaterials = data?.data?.items || [];
  ...
  return <DataTable columns={columns} data={bandMaterials} searchKey="name" />;
}
